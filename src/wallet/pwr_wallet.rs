...
impl Wallet {
    ...
    async fn get_txn_bytes(&self, tx: NewTransactionData) -> Vec<u8> {
        ...
        let txn_bytes = tx.serialize_for_broadcast(nonce, (self.get_rpc().await).chain_id, self).unwrap();
        return txn_bytes;
    }
    ...
    pub async fn send_vm_data(&self, vm_id: u64, data: Vec<u8>) -> BroadcastResponse {
        let tx = NewTransactionData::VmData { vm_id: vm_id, data: data };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn send_payable_vm_data(&self, vm_id: u64, amount: u64, data: Vec<u8>) -> BroadcastResponse {
        let tx = NewTransactionData::PayableVmData { 
            vm_id: vm_id, 
            data: data, 
            amount: amount 
        };
    ...
    pub async fn claim_vm_id(&self, vm_id: u64) -> BroadcastResponse {
        let tx = NewTransactionData::ClaimVmID { vm_id: vm_id };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn join_as_validator(&self, ip: String) -> BroadcastResponse {
        let tx = NewTransactionData::JoinAsValidator { ip: ip };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn claim_spot(&self) -> BroadcastResponse {
        ...
        let tx = NewTransactionData::ClaimSpot { validator: address };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn send_guardian_approval_transaction(&self, transactions: Vec<Transaction>) -> BroadcastResponse {
        let tx = NewTransactionData::GuardianApproval { transactions: transactions };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn set_conduits(&self, vm_id: u64, conduits: Vec<String>) -> BroadcastResponse {
        let tx = NewTransactionData::SetConduits { vm_id: vm_id, conduits: conduits };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn add_conduits(&self, vm_id: u64, conduits: Vec<u8>) -> BroadcastResponse {
        let tx = NewTransactionData::AddConduits { vm_id: vm_id, conduits: conduits };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn create_proposal_change_vm_id_claiming_fee(
        ...
        let tx = NewTransactionData::ChangeVmIdClaimingFeeProposal {
            title: title,
            description: description,
    ...
    pub async fn create_proposal_change_vm_owner_txn_fee_share(
        ...
        let tx = NewTransactionData::ChangeVmOwnerTxnFeeShareProposal {
            title: title,
            description: description,
            fee_share: fee_share,
        };
    ...
    pub async fn create_proposal_other_proposal(&self, title: String, description: String) -> BroadcastResponse {
        let tx = NewTransactionData::OtherProposalTxn { title: title, description: description };
        let txn_bytes = self.get_txn_bytes(tx).await;
    ...
    pub async fn vote_on_proposal(&self, proposal_hash: String, vote: u8) -> BroadcastResponse {
        let tx = NewTransactionData::VoteOnProposalTxn { proposal_hash: proposal_hash, vote: vote };
        let txn_bytes = self.get_txn_bytes(tx).await;
